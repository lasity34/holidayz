...
let currentLocation: [string, string, number] = ["Cape Town", "13:00", 16]
footer.innerHTML = `<div>
<p>Current Location: ${currentLocation[0]}</p>
<p>Current Time: ${currentLocation[1]}</p>
<p>Current Tempreture: ${currentLocation[2]}°C</p>
</div>`
